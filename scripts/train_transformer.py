...
modelName = 'Log-PatchMask-Transformer'
...
args['load_weights_path'] = 'logs/speech_logs/speechBaseline-PatchMask-Transformer/modelWeights'
args['seqLen'] = 150
